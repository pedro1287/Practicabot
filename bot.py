...
bot_token = "5874398931:AAFhQFhCLOcAsH9TIhIKTb_aWEPMh7w01tE"
Channel_Id = -1001844887623
bot =  Client("bot",api_id=api_id,api_hash=api_hash,bot_token=bot_token)
boss = ['raydel0307','darielxd','socram_Agm']#usuarios supremos
...
total_up = {'darielxd':{'P':0,'S':0},'raydel0307':{'P':0,'S':0}} #total en gb o megas subidos en bytes (int)
rvs = {'darielxd':{'h':'','u':'','p':'','up':'','z':0,'m':'m'},'raydel0307':{'h':'','u':'','p':'','up':'','z':0,'m':'m'}}
